...
menu = {
       ...
       { "Python",
       	 { "function",	function() menustring( "\"def f(x):\n  local y\n  y=x*x\n  return y\"" ) end },
       	 { "local",	function() menustring( "\n  local j,k\n" ) end },
       	 { "return",	function() menustring( "\n  return \n" ) end },
       	 { "print",	function() menustring( "\n  print(" ) end },
       	 { "\\n",	function() menustring( "\n  " ) end },
       	 { "if/then",	function() menustring( "\n  if :\n    " ) end },
       	 { "if/then/else",	function() menustring( "\n  if :\n    \n  else:\n    " ) end },
       	 { "for",	function() menustring( "\n  for j in range(1,10):\n    " ) end },
       	 { "while",	function() menustring( "\n  while :\n    " ) end },
       	 { "break",	function() menustring( "\n    break" ) end },
       	 { "continue",	function() menustring( "\n    continue" ) end },
       },
       { "Lists",
